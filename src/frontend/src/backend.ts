...
export class Backend implements backendInterface {
    ...
    async endSession(arg0: SessionId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async generateFocusTask(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateFocusTask(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isApiKeyConfigured(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isApiKeyConfigured();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeApiKey(arg0: OpenAIApiKey): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeApiKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSessionOutcome(arg0: SessionId, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSessionOutcome(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSessionTask(arg0: SessionId, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSessionTask(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
